...
<!--  -->
  ...
  <body>
    ...
    <section id="home-section" class="hero" style="background-image: url(images/bg_g1.png);" data-stellar-background-ratio="5.0">
	          ...
	          <div class="row d-md-flex no-gutters slider-text align-items-end justify-content-end" data-scrollax-parent="true">
		          ...
		          <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text mt-5">
			            ...
			            <h1 class="mb-4">Ponte Sexy</h1>
			            <p class="mb-4">El amor propio se muestra con unas buenas uñas.Brindamos un servicio de calidad, consintiendo siempre a nuestros
							 clientes.  JaLu Nails está para ti.</p>
	      ...
	      <div class="slider-item js-fullheight">
	        ...
	        <div class="container-fluid p-0">
	          <div class="row d-flex no-gutters slider-text align-items-center justify-content-end" data-scrollax-parent="true">
		          ...
		          <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text mt-5">
		          		<span class="subheading">Luce unas hermosas uñas.</span>
			            <h1 class="mb-4">JaLu Nails</h1>
			            <p class="mb-4">En JaLu Nails podrás agendar tu cita de una manera, rápida y eficaz. Lograr tener más claro tu diseño mediante nuestra galeria 
							en donde podrás visualizar diferentes modelos, según tu necesidad. Consciente tus uñas.
						</p>
