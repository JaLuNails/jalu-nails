...
<html lang="en">
  <head>
    <title>JaLu Nails - Contacto</title>
...
?>
          ...
          <div class="col-md-3 d-flex">
          	<div class="align-self-stretch box p-4 py-md-5 text-center">
	            ...
	            <p><a href="tel://4432908732">+ <?php  echo $row['MobileNumber'];?></a></p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="align-self-stretch box p-4 py-md-5 text-center">
	            ...
	            <p><a href="mailto:jalu.nails1@gmail.com"><?php  echo $row['Email'];?></a></p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="align-self-stretch box p-4 py-md-5 text-center">
        ...
        <div class="col-lg-9">
          <form action="includes/formulario_contacto.php" method="POST" role="form" class="php-email-form">
            <div class="row">
              <div class="col-md-6 form-group">
                <input type="text" name="nombre_completo" class="form-control" id="name" placeholder="Nombre Completo" required>
              </div>
            ...
            <div class="text-center"><button name="enviar"type="submit">Enviar Mensaje</button></div>
          </form>
        </div>
        <!-- End Contact Form -->
        </section>
